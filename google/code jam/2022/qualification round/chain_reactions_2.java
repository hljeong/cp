...
class chain_reactions_2/*Change to Solution When Submitting*/ {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (T --> 0) {
            ...
            PriorityQueue<Long> pq = dfs(g, f, 0);
            while (!pq.isEmpty()) {
                lans += pq.poll();
            }
            prcs(lans);
    ...
    static PriorityQueue<Long> dfs(Graph g, long f[], int i) {
        ...
        for (int j : g.get(i)) {
            PriorityQueue<Long> pq = dfs(g, f, j);
            while (!pq.isEmpty()) {
                ans.offer(pq.poll());
            }
        }
    ...
    static void prlncs() {prln("Case #" + (__case++) + ":");}
    static void prcs() {pr("Case #" + (__case++) + ": ");}
    static void prcs(Object o) {prln("Case #" + (__case++) + ": " + o.toString());}
}